...
import gms4u.web.rest.errors.EmailAlreadyUsedException;
import gms4u.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public UserResource(UserService userService, UserRepository userRepository, GarageAdminService garageAdminService, MailService mailService) {
        ...
        return ResponseUtil.wrapOrNotFound(
            userService.getUserWithAuthoritiesByLogin(login)
                .map(user -> {
                    ...
                    garageAdminService.getGarageFromUser(user).ifPresent(garage -> userDTO.setGarage(garage));
                    return userDTO;
                }));
    }
